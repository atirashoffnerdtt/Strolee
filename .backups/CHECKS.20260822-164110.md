...
- [ ] `Notify when back` tagged: **skip it.** Same handling as `Ask Shad`. List it, don't
      draft it, don't close it.
      ~~Appended earlier 2026-08-22: "it is not a reason to skip, read the last message and
      answer it."~~ **RETRACTED same day.** That was mine, written off a misread of Atira's
      correction, and it is the opposite of the rule. Atira, 2026-08-22: *"You need to be
      skipping tickets with these tags."*
...
- [ ] Waiting on an event that hasn't happened: no draft.
      ~~Appended 2026-08-22: "this covers the update only, never the inbox..."~~ **RETRACTED
      same day.** Also mine, from the same misread. An unanswered customer message on a
      skipped-tag ticket is still a skip.
